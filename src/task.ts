...
type TaskGenerator = GeneratorFunction
type TaskParams = { [key: string]: any }
type onStep = (task: Task) => Promise<void>

type BasicTaskArguments = {
  generator: TaskGenerator
  params?: TaskParams
  onStep?: onStep
}

export const BasicTask = ({ generator, params = {}, onStep }: BasicTaskArguments) => {
