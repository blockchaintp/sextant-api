...
declare namespace MarketplaceMetering {
  ...
  export interface ResolveCustomerRequest {
    /**
     * When a buyer visits your website during the registration process, the buyer submits a Registration Token through their browser. The Registration Token is resolved to obtain a CustomerIdentifier and Product Code.
     */
  ...
  export interface ResolveCustomerResult {
    ...
    /**
     * The Product Code is returned to confirm that the buyer is registering for your particular product. Subsequent BatchMeterUsage calls should be made using this Product Code.
     */
    ProductCode?: ProductCode;
  }
  ...
  export interface UsageRecord {
    /**
     * Timestamp of the hour, recorded in UTC. The seconds and milliseconds portions of the timestamp will be ignored. Your application may meter usage for up to one hour in the past.
     */
    Timestamp: Timestamp;
    /**
